...
<body >
    ...
    <div >
     <div class = "loginbox" >
     <form action="newsprocess" method="post">

     	<p>N_id</p>
          <input type ="text" name="nid" placeholder="News Id">

          <p>Upcoming</p>
          <input type ="text" name="upcoming" placeholder="Upcoming News">
          <p> Cost</p>
          <input type ="text" name="cost" placeholder="Total Cost">

          <p>Date</p>
          <input type ="text" name="date" placeholder="12-04-2018">
          <p>Fk Place Code</p>
          <input type ="text" name="pcode" placeholder="fk Place Code">
